...
class Register extends CI_Model
{
    ...
    public function getdata()
    {
        ...
        $this->form_validation->set_rules('username', 'User Name', 'trim|required|alpha|min_length[5]|max_length[20]|is_unique[users.username]',
            array(
                ...
                'is_unique' => 'The username you wanted is already in use, try again!',
            )
        );
        ...
        $this->form_validation->set_rules('email', 'Email ID', 'trim|required|valid_email|is_unique[users.email]',
            array(
                ...
                'is_unique'    => 'The email ID you used is already in use. Try to login.',
            )
        );
