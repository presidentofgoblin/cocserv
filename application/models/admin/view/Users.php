...
{
    private function data($limit, $page)
    {
        $usr = $this->db->select('*')->limit($limit, $page)->get('users');
    ...
    public function get()
    {
        ...
        $data = [
            ...
            'users'         => $this->data($config['per_page'], $page),
            'pagination'    => $this->pagination->create_links(),
        ];

        $this->parser->parse('admin/templates/header', $data);
        $this->parser->parse('admin/view/users', $data);
